...
var TasksController = function () {
    ...
    var TasksController = _classThis = /** @class */ (function () {
        ...
        TasksController_1.prototype.create = function (createTaskDto) {
            return this.tasksService.create(createTaskDto);
        };
        TasksController_1.prototype.findAll = function () {
            return this.tasksService.findAll();
        };
        TasksController_1.prototype.findOne = function (id) {
            return this.tasksService.findOne(+id);
        };
        TasksController_1.prototype.update = function (id, updateTaskDto) {
            var index = parseInt(id);
            var task = this.tasksService.update(index, updateTaskDto);
            return task;
        };
        TasksController_1.prototype.remove = function (id) {
